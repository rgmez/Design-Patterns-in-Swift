...
Strategy provide canonical, tested examples, and Bridge now has its tested
problem baseline; historical playground files remain outside the package until
...
- 🌁 **Bridge** — [Problem baseline](Documentation/bridge-problem.md) · [Historical draft](Structural%20Patterns/Bridge/Bridge.md) · Days 015–017
